...
公益活动
线上活动',
    'adminemail' => '18535677667@163.com',
    'adminipaccess' => '',
    ...
    'archiverredirect' => '0',
    'attachbanperiods' => '',
    'attachdir' => 'D:/phpStudy/WWW/upload/./data/attachment/',
    'attachexpire' => '',
    'attachimgpost' => '1',
    'attachrefcheck' => '0',
    'attachsave' => '3',
    'attachurl' => 'data/attachment/',
    'authkey' => '3f53bfjJGZOzSb7f',
    'authoronleft' => '1',
    'uidlogin' => '0',
    'autoidselect' => '0',
    'avatarmethod' => '0',
...
{time}',
    ...
    'transferstatus' => true,
    'ucenterurl' => 'http://localhost/upload/uc_server',
    'tradeopen' => 1,
    'medalstatus' => 0,
    'specialicon' => 
    array (
    ...
    array (
      ...
      array (
        'available' => '1',
        'navname' => '道具',
        'code' => '<a href="home.php?mod=magic" style="background-image:url(http://localhost/upload/static/image/feed/magic_b.png) !important">道具</a>',
        'level' => '0',
      ),
      'medal' => 
      array (
        'available' => '1',
        'navname' => '勋章',
        'code' => '<a href="home.php?mod=medal" style="background-image:url(http://localhost/upload/static/image/feed/medal_b.png) !important">勋章</a>',
        'level' => '0',
      ),
      'task' => 
      array (
        'available' => '1',
        'navname' => '任务',
        'code' => '<a href="home.php?mod=task" style="background-image:url(http://localhost/upload/static/image/feed/task_b.png) !important">任务</a>',
        'level' => '0',
      ),
      'friend' => 
      array (
        'available' => '0',
        'navname' => '好友',
        'code' => '<a href="home.php?mod=space&do=friend" style="background-image:url(http://localhost/upload/static/image/feed/friend_b.png) !important">好友</a>',
        'level' => '0',
      ),
      'thread' => 
      array (
        'available' => '0',
        'navname' => '帖子',
        'code' => '<a href="forum.php?mod=guide&view=my" style="background-image:url(http://localhost/upload/static/image/feed/thread_b.png) !important">帖子</a>',
        'level' => '0',
      ),
      'favorite' => 
      array (
        'available' => '0',
        'navname' => '收藏',
        'code' => '<a href="home.php?mod=space&do=favorite&view=me" style="background-image:url(http://localhost/upload/static/image/feed/favorite_b.png) !important">收藏</a>',
        'level' => '0',
      ),
    ),
    'topnavs' => 
    array (
      ...
      array (
        ...
        array (
          'available' => '1',
          'navname' => '设为首页',
          'code' => '<a href="javascript:;"  onclick="setHomepage(\'http://localhost/upload/\');">设为首页</a>',
          'type' => '0',
          'level' => '0',
          'id' => 'sethomepage',
        ),
        ...
        array (
          'available' => '1',
          'navname' => '收藏本站',
          'code' => '<a href="http://localhost/upload/"  onclick="addFavorite(this.href, \'Discuz! Board\');return false;">收藏本站</a>',
          'type' => '0',
          'level' => '0',
          'id' => 'setfavorite',
        ),
...
{uhtL111t}
<dl class="pil cl">
	<dt>{W2pPZ6T3}</dt><dd>{pzL15Jvj}</dd>
</dl>
{LA61777H}
<dl class="pil cl">{QhL13htT}</dl>',
          'top' => '<dl class="cl">
<dt>{ZATA711h}</dt><dd>{Ss2sb4FE}</dd>
</dl>',
        ),
      ),
      'code' => 
